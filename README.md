...
- **Admin panel**: type `6016` anywhere in the game to unlock a hidden ADMIN tab in the shop — MAX/buy-all buttons for each upgrade, and free-form fields to directly set distance, speed, 67s, and rebirth count. Persists once unlocked (no need to re-type it next session).
