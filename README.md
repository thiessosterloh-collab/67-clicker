...
- Beyond our own Solar System's edge (the heliopause), the journey to the far edge of the galaxy passes through **~90 procedurally-generated solar systems**, numbered as levels ("Level 6: entering system TRAPPIST-4459", with real-astronomy-style catalog names), spaced by order of magnitude across the real ~160,000-light-year span it takes to actually leave the Milky Way. Each one gets a big star and a handful of planets you zoom past, the same way you do the Moon, Mars, Jupiter and the rest at the start of the run.
